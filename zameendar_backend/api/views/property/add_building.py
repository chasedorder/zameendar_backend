...
from zameendar_backend.api.models import Building, PropertyModel, Seller
...
def update_building(request):
    ...
    property_model.property_type = PropertyTypes.Building
    ...
    building = Building.objects.get(property_model=property_model)

    building.property_model = property_model
